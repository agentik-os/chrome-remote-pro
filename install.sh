...
# Download latest DMG
DOWNLOAD_URL="https://github.com/Agentik-OS/chrome-remote-pro/releases/latest/download/ChromeRemotePro-v2.0.0.dmg"
...
if ! curl -fsSL "$DOWNLOAD_URL" -o "$TMP_DMG" 2>/dev/null; then
    ...
    # Fallback: Use generic latest release
    DOWNLOAD_URL="https://github.com/Agentik-OS/chrome-remote-pro/releases/download/v2.0.0/ChromeRemotePro-v2.0.0.dmg"
